 ...
 * @since  1.0.0
 **/
class plgSystemJooagshariffghsvs extends JPlugin
{
	/**
	 * The plugin context
	 *
	...
	public function generateHTML($config)
	{
		...
		if (!JFolder::exists(JPATH_SITE . '/cache/plg_system_jooagshariffghsvs') && $this->params->get('shariff_counter'))
		{
			JFolder::create(JPATH_SITE . '/cache/plg_system_jooagshariffghsvs', 0755);
		}
